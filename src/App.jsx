...
import FinishedProposal from "./pages/FinishedProposal";
    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<NavbarLayout/>}>
            ...
            <Route path="/submitting_proposal" element={<SubmittingProposal name="Proposal" hidden={true}/>}/>
            <Route path="/finished_proposal" element={<FinishedProposal name="Proposal" hidden={true}/>}/>
